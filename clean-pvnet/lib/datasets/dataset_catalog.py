...
class DatasetCatalog(object):
    dataset_attrs = {
        'LinemodTest': {
            'id': 'linemod',
            'data_root': 'data/linemod/{}/JPEGImages'.format(cfgs.cls_type),
            'ann_file': 'data/linemod/{}/test.json'.format(cfgs.cls_type),
            'split': 'test'
        },
        'LinemodTrain': {
            'id': 'linemod',
            'data_root': 'data/linemod/{}/JPEGImages'.format(cfgs.cls_type),
            'ann_file': 'data/linemod/{}/train.json'.format(cfgs.cls_type),
            'split': 'train'
        },
        'TlessTest': {
            'id': 'tless_test',
        ...
        'LinemodOccTest': {
            ...
            'ann_file': 'data/linemod/{}/occ.json'.format(cfgs.cls_type),
            'split': 'test'
        },
        'TlessPoseTrain': {
            'id': 'tless_train',
            'ann_file': 'data/cache/tless_pose/{}/train.json'.format(cfgs.cls_type),
            'split': 'train'
        },
        'TlessPoseMini': {
            'id': 'tless_test',
        ...
        'YcbTest': {
            'id': 'ycb',
            'ann_file': 'data/YCB/posedb/{}_val.pkl'.format(cfgs.cls_type),
            'data_root': 'data/YCB'
        },
	'CustomTrain': {
            'id': 'custom',
