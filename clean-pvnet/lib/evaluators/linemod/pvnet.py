...
import numpy as np
from lib.utils2.pvnet import pvnet_pose_utils, pvnet_data_utils
import os
from lib.utils2.linemod import linemod_config
import torch
if cfgs.test.icp:
    from lib.utils2.icp import icp_utils
    # from lib.utils.icp.icp_refiner.build import ext_
if cfgs.test.un_pnp:
    from lib.csrc.uncertainty_pnp import un_pnp_utils
    import scipy
from PIL import Image
from lib.utils2.img_utils import read_depth
from scipy import spatial
from lib.utils2.vsd import inout
...
class Evaluator:
    ...
    def __init__(self, result_dir):
        self.result_dir = os.path.join(result_dir, cfgs.test.dataset)
        ...
        self.icp_refiner = icp_utils.ICPRefiner(model, (self.width, self.height)) if cfgs.test.icp else None
        # if cfg.test.icp:
